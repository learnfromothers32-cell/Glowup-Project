  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-sm sm:text-base text-gray-400 max-w-md mx-auto leading-relaxed mb-8">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-50 border border-gray-100 text-xs text-gray-400">
          <Sparkles size={12} />
          Phase 2 – Coming Soon
        </div>
      </main>
