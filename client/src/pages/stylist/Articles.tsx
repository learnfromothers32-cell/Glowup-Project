...
export default function Articles() {
  ...
  return (
    <div className="space-y-6">
      {/* Success Toast */}
      {successMsg && (
        <div className="fixed top-6 right-6 z-[60] flex items-center gap-2.5 px-5 py-3 bg-green-50 border border-green-200 rounded-xl shadow-lg text-sm font-medium text-green-700 animate-in slide-in-from-right-2">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
          />
        </div>
      ...
      {editorMode !== 'none' && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-8 pb-8 bg-black/50 backdrop-blur-sm overflow-y-auto">
          <div className="w-full max-w-4xl mx-4 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            {/* Editor Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
              ...
              <button onClick={closeEditor} className="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-400 transition-colors">
                <X size={18} />
              </button>
            </div>
            ...
            <div className="px-6 py-5 space-y-5 max-h-[65vh] overflow-y-auto">
              {/* Image Upload */}
              <div>
                <label className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-2">Cover Image *</label>
                <div
                  ref={dropRef}
                  ...
                  className={`relative rounded-xl border-2 border-dashed transition-all ${
                    imagePreview
                      ...
                      : 'border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/50 hover:border-brand-300 dark:hover:border-brand-600'
                  }`}
                >
                  {imagePreview ? (
                    <div className="relative aspect-[2/1] rounded-xl overflow-hidden group">
                      ...
                      <button
                        ...
                        className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/90 flex items-center justify-center text-gray-600 hover:bg-white shadow-sm opacity-0 group-hover:opacity-100 transition-all"
                      >
                        <X size={14} />
                      </button>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
                  maxLength={120}
                />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full appearance-none px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
                    >
                      {CATEGORIES.map((c) => (
              ...
              {/* Excerpt */}
              <div>
                <label className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1.5">Excerpt *</label>
                <textarea
                  value={form.excerpt}
                  ...
                  rows={2}
                  maxLength={300}
                  className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 resize-none"
                />
                <p className="text-[10px] text-gray-400 mt-1 text-right">{form.excerpt.length}/300</p>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-xs font-medium text-brand-600 dark:text-brand-400 hover:text-brand-700 px-2.5 py-1 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-950/20 transition-colors"
                  >
                    <Plus size={12} />
                    Add paragraph
                  </button>
                ...
                <div className="space-y-2.5">
                  {form.content.map((p, i) => (
                    <div key={i} className="flex gap-2.5 items-start group">
                      <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-gray-100 dark:bg-gray-800 text-[10px] font-bold text-gray-500 shrink-0 mt-2.5 group-hover:bg-brand-50 group-hover:text-brand-600 transition-colors">
                        {i + 1}
                      </div>
                      ...
                      <button
                        ...
                        className="p-2 mt-2.5 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-red-50 dark:hover:bg-red-950/20 text-gray-400 hover:text-red-500 transition-all"
                      >
                        <X size={14} />
                      </button>
                    </div>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
              <button
                onClick={closeEditor}
                className="px-5 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-all"
              >
                Cancel
              </button>
              <button
      ...
      {deleteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="w-full max-w-sm mx-4 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            {articles.map((a) => {
              ...
              return (
                <div
                  key={a.id}
                  className="group flex items-start gap-4 p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:hover:border-gray-700 hover:shadow-sm transition-all"
                >
                  <div className="w-20 h-16 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800 shrink-0 hidden sm:block">
                    <img
                      src={a.image}
                      alt=""
                  ...
                  <div className="flex items-center gap-0.5 shrink-0 self-center">
                    <button
                      ...
                      className="p-2.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                    ...
                    <button
                      onClick={() => openEdit(a)}
                      className="p-2.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-400 hover:text-brand-600 transition-colors"
                      title="Edit"
                    >
                      <Edit2 size={15} />
                    </button>
                    <button
                      ...
                      className="p-2.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/20 text-gray-400 hover:text-red-500 transition-colors"
                      title="Delete"
                    >
                      <Trash2 size={15} />
                    </button>
