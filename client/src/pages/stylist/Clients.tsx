    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="px-2 sm:px-0">
      ...
      {selected && (
        ...
        >
          ...
          <div
            className="relative w-full sm:max-w-xl lg:max-w-2xl max-h-[92vh] sm:max-h-[90vh] overflow-y-auto bg-white dark:bg-surface-dark-secondary rounded-t-2xl sm:rounded-2xl shadow-modal animate-slide-up"
          ...
          >
            ...
            {!detailLoading && !detailError && detailData && (
              <>
                ...
                <div className="sticky bottom-0 bg-white/95 dark:bg-surface-dark-secondary/95 backdrop-blur-md border-t border-gray-100 dark:border-gray-700/40 px-5 sm:px-7 py-3 sm:py-4">
