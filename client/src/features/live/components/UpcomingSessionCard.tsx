    ...
    <div className="bg-white dark:bg-[#1a1a2e] rounded-2xl border border-gray-100 dark:border-0 shadow-sm hover:shadow-md transition-all duration-200 p-4">
      <div className="flex items-start gap-3">
        <button
          ...
          className="shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 flex items-center justify-center text-xs font-semibold text-gray-500 dark:text-gray-300 cursor-pointer hover:opacity-80 transition-opacity"
        >
      ...
      <div className="flex items-center gap-4 mt-3 pt-3 border-t border-gray-50 dark:border-gray-700/30">
