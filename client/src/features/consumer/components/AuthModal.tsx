// src/features/consumer/components/AuthModal.tsx
      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl w-full max-w-md p-6 relative shadow-2xl">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
            {mode === "login" ? "Welcome back" : "Join GlowUp"}
          </h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
            {mode === "login"
              ? "Sign in to continue booking"
              : "Create an account to book top stylists"}
          </p>
        </div>
        ...
        <div className="space-y-2 mb-5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 bg-black text-white rounded-xl hover:bg-gray-900 transition dark:hover:bg-gray-200"
          >
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-3">
          {mode === "signup" && (
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-200 dark:border-gray-700 bg-transparent dark:bg-gray-800 text-gray-900 dark:text-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-gray-900 dark:bg-indigo-600 text-white rounded-xl font-medium hover:bg-gray-800 dark:hover:bg-indigo-500 transition disabled:opacity-50"
          >
        ...
        <div className="mt-5 text-center text-sm">
          ...
          <button
            ...
            className="text-purple-600 dark:text-indigo-400 hover:underline font-medium"
          >
