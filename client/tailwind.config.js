  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-sm': '0 0 12px rgba(244,63,94,0.2)',
        'glow-gold': '0 0 20px rgba(212,167,106,0.3)',
        'glow-stylist': '0 0 20px rgba(99,102,241,0.3)',
      },
      animation: {
      ...
      keyframes: {
        ...
        pulseGlow: { '0%, 100%': { boxShadow: '0 0 20px rgba(244,63,94,0.2)' }, '50%': { boxShadow: '0 0 30px rgba(244,63,94,0.4)' } },
      },
    },
  },
  plugins: [],
